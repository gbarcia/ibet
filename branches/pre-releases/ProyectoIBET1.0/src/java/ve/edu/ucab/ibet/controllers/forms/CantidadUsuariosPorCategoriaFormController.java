...
public class CantidadUsuariosPorCategoriaFormController extends SimpleFormController {
    ...
    public CantidadUsuariosPorCategoriaFormController() {
        setCommandClass(FechasTO.class);
        setCommandName("reporteCantidadUsuariosPorCategoria");
    }
    ...
    protected ModelAndView onSubmit(HttpServletRequest req, HttpServletResponse resp, Object command, BindException errors) {
        ...
        try {
            mv = new ModelAndView(new RedirectView("/ProyectoIBET/repCantidadUsuariosPorCat" + agregado + extReporte ));
