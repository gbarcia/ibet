...
public class CategoriasPerdidasFormController extends SimpleFormController {
    ...
    public CategoriasPerdidasFormController() {
        setCommandClass(FechasTO.class);
        setCommandName("reportePerdidas");
    }
    ...
    protected ModelAndView onSubmit(HttpServletRequest req, HttpServletResponse resp, Object command, BindException errors) {
        ...
        try {
            mv = new ModelAndView(new RedirectView("/ProyectoIBET/repCategoriasPerdidas" + agregado + extReporte +
